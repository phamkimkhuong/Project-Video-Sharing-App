...
const CreateVideoScreen: React.FC<Props> = ({ navigation, route }: Props) => {
  ...
  let stopRecording = () => {
    // @ts-ignorecomment
    navigation.navigate("Editing", { result: image, media, mediaType, user });
    setIsRecording(false);
              ...
              >
                ...
                >
                  <View
                    style={[
                      styles.buttonRecord,
                      isRecording ? { borderColor: "#de3b40" } : "",
                    ]}
                  >
                    <View
                      style={[
