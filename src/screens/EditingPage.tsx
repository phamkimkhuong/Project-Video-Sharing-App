...
const EditingPage: React.FC<Props> = ({ navigation, route }: Props) => {
  // toggle comment
  ...
  const { media, mediaType, user } = route.params as {
    media: any;
    mediaType: string;
    user: { idUser: number };
  };
  ...
  const post = () => {
    postMedia(user.idUser, mediaType, result, navigation);
  };
          ...
          >
            ...
            <View style={{ width: screenWidth / 2 - 20 }}>
              <Switch
                ...
                ios_backgroundColor="#3e3e3e"
                onValueChange={() =>
                  setIsPostFacebook((previousState) => !previousState)
                }
          ...
          >
            ...
            <View style={{ width: screenWidth / 2 - 20 }}>
              <Switch
                ...
                ios_backgroundColor="#3e3e3e"
                onValueChange={() =>
                  setIsPostTwitter((previousState) => !previousState)
                }
                value={isPostTwitter}
              />
            </View>
          ...
          >
            ...
            <View style={{ width: screenWidth / 2 - 20 }}>
              <Switch
                ...
                ios_backgroundColor="#3e3e3e"
                onValueChange={() =>
                  setIsPostInstagram((previousState) => !previousState)
                }
